        ...
        <div className="min-h-screen bg-surface text-primary-dark pb-safe-bottom">
            <div className="max-w-md mx-auto px-6 pt-12 text-center">
                <div className="flex justify-end p-4">
                    <button
                        onClick={() => signOut()}
                        className="px-4 py-2 rounded-lg bg-primary-dark/5 border border-primary-dark/10 text-[12px] font-bold hover:bg-white hover:text-red-600 transition-all flex items-center gap-2"
                    >
