...
describe("Room ID API", () => {
    ...
    describe("GET", () => {
        ...
        it("should return 404 if room not found", async () => {
            vi.mocked(roomService.getRoomById).mockRejectedValue(new Error("Room not found"));
    ...
    describe("PUT", () => {
        it("should update room with valid data", async () => {
            ...
            vi.mocked(roomService.updateRoom).mockResolvedValue({ id: "room-1", ...input } as any);
    ...
    describe("DELETE", () => {
        it("should delete room and return 204", async () => {
            vi.mocked(roomService.deleteRoom).mockResolvedValue({ id: "room-1" } as any);
